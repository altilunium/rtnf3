...
## Use "Clean URLs".
$EnablePathInfo = 1;
$ScriptUrl = "http://localhost/r3";
$ScriptUrl = $UrlScheme.'://'.$_SERVER['HTTP_HOST'].'/r3';
...
$EnableUpload = 1;
$UploadPermAdd = 0;
$UploadMaxSize = 100*1024*1024; //limit uploads to 25 MiB
$UploadPrefixFmt = '/$Group/$Name';
//$DefaultPasswords['upload'] = pmcrypt('rtnf');
...
# Markup("'*", "<'''''", "/'\\*(.*?)\\*'/", "<b>$1</b>");    # '*bold*'
 ...
 //Markup("prop","<''","/;(.*?);/",'<strong>$1</strong>');
Markup("property","inline","/;(.*?);/",'<strong>$1</strong>');
...
$DefaultPasswords['admin'] = pmcrypt('rtnf');
