...
SDVA($InputTags['textarea'], array(
  ...
  ':html' => "<textarea autofocus \$InputFormArgs>\$InputFormContent</textarea>"));
...
SDVA($InputTags['e_form'], array(
  ':html' => "<form name='nodeeditor' action='{\$PageUrl}?action=edit' method='post'
    \$InputFormArgs><input type='hidden' name='action' value='edit' 
    /><input type='hidden' name='n' value='{\$FullName}' 
    /><input type='hidden' name='basetime' value='\$EditBaseTime' 
    />"));
SDVA($InputTags['e_textarea'], array(
  ':html' => "<textarea class='demo demo-textarea' autofocus spellcheck='false' \$InputFormArgs 
...
SDVA($InputTags['e_savebutton'], array(
  ':html' => "<input type='submit' style='position:absolute;top:0;display:none' \$InputFormArgs />",
